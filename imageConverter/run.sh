...
ffmpeg -y -framerate 25 -i "$directory/index%d.webp" -vf reverse -c:v libx264 -pix_fmt yuv420p -profile:v baseline -level 3.0 -movflags +faststart "$directory/output.mp4"
